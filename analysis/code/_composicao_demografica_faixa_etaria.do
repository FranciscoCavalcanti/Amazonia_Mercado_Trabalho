...
replace id = "Acima de 60 anos" if id==""
...
* 		Grafico 
		...
		*/	legend( order(1 2 3 4 5) cols(5) label(1 "14 a 17 anos") label(2 "18 a 24 anos") label(3 "25 a 39 anos") label(4 "40 a 59 anos") label(5 "Acima de 60 anos") size(vsmall) )	/*
