...
* select variables
ds n_de_formal_gape_transporte n_de_formal_gape_alimentacao n_de_formal_gape_informacao n_de_formal_gape_publica n_de_formal_gape_educacao n_de_formal_gape_outros n_de_formal_gape_domestico
...
* local notes
local ttitle "Número total de \textbf{formal} por setor de Serviços - 2019"
local tnotes "Valores correspondem a média entre os trimestres da PNAD Contínua 2019"

#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\retrato_emprego\_retrato_emprego_setor_gape_table_n_de_formal.tex", 
	replace 
	booktabs
    ...
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{_retrato_emprego_setor_gape_table_n_de_formal}"
