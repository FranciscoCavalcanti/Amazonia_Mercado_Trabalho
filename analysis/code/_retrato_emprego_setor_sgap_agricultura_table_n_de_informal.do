...
* select variables
ds n_de_informal_sgap_agricultura 	/*
	*/ 	n_de_informal_sgap_animal 	/*
	*/ 	n_de_informal_sgap_florestal
...
* local notes
local ttitle "Número total de \textbf{informal} por setor de Agropecuária - 2019"
local tnotes "Valores correspondem a média entre os trimestres da PNAD Contínua 2019"

#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\retrato_emprego\_retrato_emprego_setor_spap_agricultura_table_n_de_informal.tex", 
	replace 
	booktabs
    ...
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{_retrato_emprego_setor_spap_agricultura_table_n_de_informal}"
	...
	nomtitle 
	coeflabels(
		n_de_informal_sgap_agricultura "Agricultura" 
		n_de_informal_sgap_animal "Agropecuária"
		n_de_informal_sgap_florestal "Produção florestal" 
	)
    ;
#delim cr
