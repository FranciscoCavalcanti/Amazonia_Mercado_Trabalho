...
* select variables
ds n_de_formal_sgap_extrativa 	/*
	*/ 	n_de_formal_sgap_trans 	/*
	*/ 	n_de_formal_sgap_energia 	/*
	*/ 	n_de_formal_sgap_agua 
...
* local notes
local ttitle "Número total de \textbf{formal} por setor de Indústria - 2019"
local tnotes "Valores correspondem a média entre os trimestres da PNAD Contínua 2019"

#delim ;    
esttab matrix(A, fmt(%16,0fc)) using "$output_dir\retrato_emprego\_retrato_emprego_setor_spap_industria_table_n_de_formal.tex", 
	replace 
	booktabs
    ...
    prehead(
        "\begin{table}[H]"
        "\centering"
		"\label{_retrato_emprego_setor_spap_industria_table_n_de_formal}"
	...
	nomtitle 
	coeflabels(
		n_de_formal_sgap_extrativa "Indústrias extrativas" 
		n_de_formal_sgap_trans "Indústrias de transformação"
		n_de_formal_sgap_energia "Eletricidade, gás e outras utilidades" 
		n_de_formal_sgap_agua "Água, esgoto e gestão de resíduos"
	)
    ;
#delim cr
