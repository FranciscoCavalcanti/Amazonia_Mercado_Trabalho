...
\input{./_sub_code_proportions/_estrutura_emprego}

\section{Estrutura da Renda}

\input{./_sub_code_proportions/_estrutura_renda}

\section{Programas Sociais e Outras Rendas}

\input{./_sub_code_proportions/_programas_sociais_outras_rendas}

\section{Transição de Ocupações}

\input{./_sub_code_proportions/_transicao_ocupacao}

\section{Composição Demográfica}

\input{./_sub_code_proportions/_composicao_demografica}
