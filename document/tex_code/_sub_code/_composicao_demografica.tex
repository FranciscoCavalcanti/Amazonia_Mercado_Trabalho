\begin{frame}[label=_composicao_demografica]{Programas Sociais}
...
\input{./_sub_code/_composicao_demografica_raca}
\input{./_sub_code/_composicao_demografica_genero}
\input{./_sub_code/_composicao_demografica_faixa_etaria}
\input{./_sub_code/_composicao_demografica_educacao}
\input{./_sub_code/_composicao_demografica_setor}
\input{./_sub_code/_composicao_demografica_regiao_metro}
\input{./_sub_code/_composicao_demografica_rural_urbano}
